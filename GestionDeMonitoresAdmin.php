...
<head>
    <title>Gymnasio Kategym :: Gesti&oacute;n de Monitores</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Gesti&oacute;n de Monitores</div>
                <div class="ContGestAdmin">
                    <?php include 'GestMonitoresAdmin.php'; ?>
                </div>
            </div>
