...
<head>
    <title>Gymnasio Kategym :: Modificar Datos</title>
    ...
    <script type="text/javascript" language="javascript" src="JavascriptProyecto/javascript_ModificaRegistrosUsuarios.js"></script>
</head>
