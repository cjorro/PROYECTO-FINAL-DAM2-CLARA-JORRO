...
<head>
    <title>Gymnasio Kategym :: Almacenar Nuevo Monitor</title>
    ...
    <script type="text/javascript" language="javascript" src="JavascriptProyecto/javascript_nuevoMonitor.js"></script>
</head>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Almacenar Nuevo Monitor</div>
                <div class="ContGestAdmin">
                    <?php include 'AlmacenarNuevoMonitor.php'; ?>
                </div>
            </div>
