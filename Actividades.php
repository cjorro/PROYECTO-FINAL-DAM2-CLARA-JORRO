...
<head>
    <title>Gymnasio Kategym :: Actividades</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                 <div class="TituloActividades">Actividades del Gymnasio Kategym</div>
                 <div class="ContieneIframe">
                    <iframe class="contieneActividades" name="TodasActividades" src="ListadoDeActividades.php"></iframe>
                 </div>
            </div>
