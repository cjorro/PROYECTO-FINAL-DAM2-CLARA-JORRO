...
<head>
    <title>Gymnasio Kategym :: Control de Accesos</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Control de accesos</div>
                <div class="ContieneTControl">
                    <?php include "MuestraTblControl.php"?>
                </div>
            </div>
