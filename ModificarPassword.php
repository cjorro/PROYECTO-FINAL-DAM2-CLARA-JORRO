...
<head>
    <title>Gymnasio Kategym :: Cambiar Contrase&ntilde;a</title>
    ...
    <script type="text/javascript" language="javascript" src="JavascriptProyecto/javascript_ModificaContraseniaUsuario.js"></script>
</head>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Cambiar Contrase&ntilde;a</div>
                <div class="ContModDatos">
                    <?php
                    
                        if($_SESSION['EstadoUsuario']==1 && $_SESSION['TipoUsuario']==2)
                            include 'UsuarioNopagado.php';
                        else
                            include 'PassUserKate.php';  
                    ?>
                </div>
            </div>
