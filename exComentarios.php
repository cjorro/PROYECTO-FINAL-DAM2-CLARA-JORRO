...
<head>
    <title>Gymnasio Kategym :: Gesti&oacute;n de Comentarios</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Gesti&oacute;n de Comentarios</div>
                <div class="ContGestAdmin">
                        <?php
                            if(isset($_GET['Opc']) && $_GET['Opc']!="")
                            {
                                if($_GET['Opc']=="Ver")
                                  {
                                    header('location:exVerComentarios.php');
                                  }
                                if($_GET['Opc']=="Nuevo")
                                  {
                                    header('location:exNuevoComentario.php');
                                  }
                            }
                            else
                            {
                                include 'exElijaOpcionComentario.php';
                            }
