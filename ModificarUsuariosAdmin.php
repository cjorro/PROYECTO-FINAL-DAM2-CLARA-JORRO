...
<head>
    <title>Gymnasio Kategym :: Gesti&oacute;n de Modificaci&oacute;n de Usuarios</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Gesti&oacute;n de Modificaci&oacute;n de Usuarios</div>
                <div class="ContGestAdmin">
                    <?php include 'ModifUsuariosAdmin.php'; ?>
                </div>
            </div>
