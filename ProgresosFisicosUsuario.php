...
<head>
    <title>Gymnasio Kategym :: Gestionar Progresos F&iacute;sicos Usuario</title>
    ...
    <script type="text/javascript" language="javascript" src="JavascriptProyecto/javascript_ProgresosFisicosUsuario.js"></script>
</head>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Gestionar progresos f&iacute;sicos Usuario</div>
                <div class="ContActUser">
                    <?php 
                        if($_SESSION['EstadoUsuario']==1)
                            include 'UsuarioNopagado.php';
                        else                    
                            include 'GestProgFisUser.php';
                    ?>
                </div>
            </div>
