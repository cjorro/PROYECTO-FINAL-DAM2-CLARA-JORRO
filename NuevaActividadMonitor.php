...
<head>
    <title>Gymnasio Kategym :: Almacenar nueva actividad</title>
    ...
    <script type="text/javascript" language="javascript" src="JavascriptProyecto/javascript_NuevaActividad.js"></script>
</head>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Almacenar nueva actividad</div>
                <div class="ContActUser">
                    <?php include 'NewActividadMonitor.php';  ?>
                </div>
            </div>
