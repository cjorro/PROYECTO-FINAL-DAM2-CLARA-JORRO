...
<head>
    <title>Gymnasio Kategym :: Gestionar Actividades Monitor</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Gestionar actividades Monitor</div>
                <div class="ContActUser">
                    <?php include 'GestActivMonit.php';  ?>
                </div>
            </div>
