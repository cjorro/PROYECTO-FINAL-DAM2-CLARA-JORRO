...
<head>
    <title>Gymnasio Kategym :: Gestionar Progresos F&iacute;sicos Monitor</title>
    ...
    <div class="pagina">
        ...
        <div class="contenido">
            ...
            <div class="muestraTodo">
                <div class="TituloPagPrincipal">Gestionar Progresos F&iacute;sicos Monitor</div>
                <div class="ContActUser">
                    <?php include 'GestProgesosFisicosMonit.php';  ?>
                </div>
            </div>
